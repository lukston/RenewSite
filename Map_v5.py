...
with score_tab:
    ...
    site_score_data[np.isnan(site_score_data)] = 0
    ...
    colormap_score.caption = 'Site Score (Wind Speed × Air Density)'
    colormap_score.add_to(site_map)

    for i in range(0, site_score_data.shape[0], 50):
        for j in range(0, site_score_data.shape[1], 50):
